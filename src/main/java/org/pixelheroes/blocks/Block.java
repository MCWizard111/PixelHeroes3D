package org.pixelheroes.blocks;

import com.google.common.collect.Maps;
import org.pixelheroes.client.render.EnumRenderPass;
import org.pixelheroes.entity.Entity;
import org.pixelheroes.items.IStackable;
import org.pixelheroes.maths.AABB;
import org.pixelheroes.maths.Vector3;
import org.pixelheroes.modding.AddonContainer;
...
public class Block implements IStackable {
	...
	public void onUse(Entity user, float x, float y, float z, EnumSide side, CollisionType type) {
		if (type != CollisionType.BLOCK) return;
